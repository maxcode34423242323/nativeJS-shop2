...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var api;
      item.closest('.popup-deign') ? api = path.designer : api = path.question;
      console.log(api);
...
var modals = function modals() {
  var modalState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var btnPressed;
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (i) {
      i.addEventListener('click', function (e) {
        ...
        imgGifts.style.marginRight = "".concat(scroll, "px");
      });
    });
  ...
  function showModalBytime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        var imgGifts = document.querySelector('.fixed-gift');
        document.body.style.marginRight = "".concat(scroll, "px");
        /* document.body.style.overflow = 'hidden' */

        imgGifts ? imgGifts.style.marginRight = "".concat(scroll, "px") : null;
      }
    }, time);
  }
